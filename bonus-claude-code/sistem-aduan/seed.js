...
async function seed() {
  try {
    ...
    // Cipta pengguna admin contoh (kata laluan di-hash oleh model).
    await User.daftar('admin', 'kpdn1234', 'Pentadbir KPDN', 'admin');

    console.log(`✅ ${dataContoh.length} aduan contoh berjaya dimasukkan.`);
    console.log('✅ Akaun admin dicipta — username: admin · kata laluan: kpdn1234');
  } catch (error) {
